				...
				while ($product = mysqli_fetch_assoc($result1)) {
					...
					<div class="product">
						<div class="product-img">
							<img src="http://localhost/iug1/project/Dashboard/Uploads/images/'.$file["image"].'" alt="">
						...
						<div class="product-body">
							...
							<h3 class="product-name"><a href="show_product.php?category_id=' . $product["category_id"] . '">' . $product["name"] . '</a></h3>
